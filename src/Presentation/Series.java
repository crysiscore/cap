...
public class Series
  extends JFrame
{
  static final String SERIE_FILE_NAME = "C:\\serial_geral\\serialno\\series.txt";
  static final String OUTPUT_FILE_NAME = "C:\\serial_geral\\serialno\\log.txt";
  static final String HISTORY_FILE = "C:\\serial_geral\\serialno\\history.txt";
  ...
  public void populacombo()
  {
    try
    {
      List<String> lines = this.text.readSmallTextFile("C:\\serial_geral\\serialno\\series.txt");
  ...
  private void initComponents()
  {
    ...
    jPanel3Layout.setHorizontalGroup(jPanel3Layout
      ...
      .addGap(20, 20, 20)
      .addComponent(this.jScrollPane2, -2, 744, -2)
      .addContainerGap(24, 32767)));
    
    jPanel3Layout.setVerticalGroup(jPanel3Layout
      .createParallelGroup(GroupLayout.Alignment.LEADING)
      .addGroup(jPanel3Layout.createSequentialGroup()
      .addComponent(this.jScrollPane2, -1, 213, 32767)
      .addContainerGap()));
    
    this.jPanel1.add(this.jPanel3, new AbsoluteConstraints(50, 330, 800, 250));
    this.jPanel3.getAccessibleContext().setAccessibleName("Nidas");
    
    this.jPanel2.setBorder(BorderFactory.createTitledBorder(null, "Imprimir Numero de serie", 0, 0, new Font("Tahoma", 0, 14)));
    ...
    this.tf_quantidade.setBackground(new Color(246, 244, 244));
    this.jPanel2.add(this.tf_quantidade, new AbsoluteConstraints(140, 100, 150, 28));
    ...
    this.btn_print.addActionListener(new ActionListener()
    {
      ...
      {
        Series.this.btn_printActionPerformed(evt);
      }
    });
    this.jPanel2.add(this.btn_print, new AbsoluteConstraints(40, 180, 110, 30));
    
    this.jPanel1.add(this.jPanel2, new AbsoluteConstraints(50, 60, 780, 230));
    ...
    getContentPane().add(this.jPanel1, new AbsoluteConstraints(0, 0, 900, 610));
    ...
    this.btn_clear.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        Series.this.btn_clearActionPerformed(evt);
      }
    });
  ...
  {
    String quantidade = this.tf_quantidade.getText();
    if (quantidade.isEmpty()) {
      ...
      try
      {
        ...
        File batchFile = new File("C:\\serial_geral\\serialno\\arquivosbat\\" + this.cmbCategoria.getSelectedItem().toString());
        
        File outputFile = new File(String.format("C:\\serial_geral\\serialno\\log.txt", new Object[0]));
        ...
        List<String> lines = this.text.readSmallTextFile("C:\\serial_geral\\serialno\\log.txt");
        for (int i = 0; i < lines.size(); i++)
        {
          String get = (String)lines.get(i);
        ...
        List<String> history = this.text.readSmallTextFile("C:\\serial_geral\\serialno\\history.txt");
        ...
        this.text.writeSmallTextFile(history, "C:\\serial_geral\\serialno\\history.txt");
  ...
  public static void main(String[] args)
  {
    EventQueue.invokeLater(new Runnable()
    {
      public void run()
      {
        ...
        se.setTitle("Imprimir numero de serie");
        se.setVisible(true);
      }
    });
  }
